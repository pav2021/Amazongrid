...
public class NavigateActions {
	...
	//@FindBy(xpath = "//input[@type='submit'][@aria-labelledby='GLUXZipUpdate-announce']//input[@type='submit'][@aria-labelledby='GLUXZipUpdate-announce']")
	
	// for the visibility of delivery pincode element
	@CacheLookup
	@FindBy(id = "contextualIngressPtLabel_deliveryShortLine")
	private WebElement deliveryPincodeVisibility;
	...
	public String accountsAction() {
		...
		ExpectedConditions.visibilityOf(CreateaWishList));
		element.click();
	...
	public String mobilePriceAction() {
		...
		WebDriverWait wait = new WebDriverWait(driver, 10);
		WebElement element = wait.until(
		ExpectedConditions.visibilityOf(signOut));
		element.click();
		amazonIconLink.click();
		String getPrice;
	...
	public String deliveryLocationAction() {
		...
		//WebDriverWait wait = new WebDriverWait(driver, 10);
		//WebElement element = wait.until(
				//ExpectedConditions.visibilityOf(deliveryPincode));
